...
| 3a | Orchard | y = □ □ □ | y = x + 2 | none | 5 | 0 to 10 | 0 to 15 | (10, 12) |
...
| 9a | Hollow | y = □ □ □ □ | y = 5x + 2 | none | left parenthesis | 0 to 5 | 0 to 20 | (3.5, 20) |
| 9b | Hollow | y = □ □ □ □ | y = 2x + 5 | 11 Paren Grove | none | 0 to 10 | 0 to 25 | (10, 25) |
| 7b | Canopy | y = \|x - □\| | y = \|x - 2\| | 12 Southreach | none | 0 to 10 | 0 to 8 | (10, 8) |
| 10a | Eastreach | y = □ □ □ □ | y = 2x - 5 | 13 Weir | none | 0 to 10 | -5 to 15 | (10, 15) |
| 11a | Paren Grove | y = □ □ □ □ )^2 | y = (2 + x)^2 | none | 1 | -2 to 3 | 0 to 25 | (3, 25) |
| 12a | Southreach | y = □ □ □ □ )^2 | y = (x + 1)^2 | 14 Forge | none | -1 to 4 | 0 to 25 | (4, 25) |
| 13a | Weir | y = □ □ □ □ | y = 5x - 1 | none | / | 0 to 5 | -1 to 20 | (4, 20) |
| 8b | Crossroads | y = □ □ □ □ □ | y = 5 / x + 2 | 15 South Vault | none | -10 to 10 | -10 to 10 | (-0.5, -10) |
| 14a | Forge | y = □ □ □ □ | y = 2x / 1 | 16 Anvil | none | 0 to 10 | 0 to 20 | (10, 20) |
| 15a | South Vault | y = □x / □ | y = 5x / 2 | 17 Cellar | none | 0 to 8 | 0 to 20 | (8, 20) |
| 16a | Anvil | y = □ □ □ □ | y = 5 - 2x | none | ^ | -5 to 5 | -10 to 15 | (5, -5) |
| 8c | Crossroads | y = □ □ □ □ □ | y = 5 - x ^ 2 | 18 Echo | none | -10 to 10 | -10 to 10 | (4, -10) |
| 17a | Cellar | y = x □ □ + □ | y = x ^ 2 + 5 | 19 Loft | none | -4 to 4 | 0 to 21 | (4, 21) |
| 18a | Echo | y = □ □ □ □ )^2 | y = (x - 5)^2 | none | right parenthesis | 0 to 10 | 0 to 25 | (10, 25) |
| 8d | Crossroads | y = □ □ □ □ □ | y = (x + 2) | 20 Finale | none | -10 to 10 | -10 to 10 | (8, 10) |
| 19a | Loft | r = □ | r = 2 | none | theta | -3 to 2 | -2.5 to 2.5 | (2, 0) |
| 19b | Loft | r = □ | r = theta | 21 Weave | none | -3 to 3 | -3 to 3 | (-3, 0) |
| 20a | Finale | y = □ □ □ □ □ □ | y = 5x ^ 2 + 1 | 22 Circle Garden | none | -2 to 2 | 0 to 21 | (2, 21) |
| 21a | Weave | r = □ □ | r = 2theta | 23 Spiral Step | none | -6.5 to 6.5 | -6.5 to 6.5 | (-6.5, 0) |
...
| 24a | Ellipse Hall | x ^ 2 / □ □ + y ^ 2 / □ = 1 | x ^ 2 / 25 + y ^ 2 / 1 = 1 | 26 Hyperbola Door | none | -5 to 5 | -5 to 5 | (5, 0) |
...
| 27a | Rose Garden | r = □(□theta) | r = sin(2theta) | 28 Cardioid | none | -4.5 to 0.5 | -4.5 to 0.5 | (0.5, 0.5) |
| 27b | Rose Garden | r = □ □(□theta) | r = 5sin(2theta) | 29 Lemniscate | none | -3.5 to 3.5 | -3.5 to 3.5 | (3.5, 3.5) |
| 28a | Cardioid | r = □ + □(theta) | r = 1 + sin(theta) | 30 Witch Window | none | -2.5 to 2.5 | -3 to 2 | (0, 2) |
| 29a | Lemniscate | (x ^ 2 + y ^ 2) ^ 2 = □ □(x ^ 2 - y ^ 2) | (x ^ 2 + y ^ 2) ^ 2 = 25(x ^ 2 - y ^ 2) | 31 Serpentine | none | -5 to 5 | -5 to 5 | (5, 0) |
| 30a | Witch Window | y = □ / (x ^ 2 + □) | y = 5 / (x ^ 2 + 1) | 32 Spiral Loft | none | -5 to 5 | 0 to 5 | (0, 5) |
| 31a | Serpentine | y = x / (x ^ 2 + □) | y = x / (x ^ 2 + 1) | 33 Fermat Spiral | none | -5 to 5 | -2.5 to 2.5 | (5, 0) |
| 32a | Spiral Loft | r = □ | r = theta | 34 Final Rose | none | -3 to 3 | -3 to 3 | (-3, 0) |
| 33a | Fermat Spiral | r ^ 2 = □ | r ^ 2 = theta | 34 Final Rose | none | -2 to 4 | -3 to 3 | (-2, 0) |
| 34a | Final Rose | r = □ □(□theta) | r = 5sin(2theta) | victory | none | -3.5 to 3.5 | -3.5 to 3.5 | (3.5, 3.5) |
