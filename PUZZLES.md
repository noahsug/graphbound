...
| 8c | Crossroads | y = 5 - x ^ □ | y = 5 - x ^ 2 | 18 Echo | none | -10 to 10 | -10 to 10 | (4, -10) |
| 17a | Cellar | y = x □ 2 + 5 | y = x ^ 2 + 5 | 19 Loft | none | -4 to 4 | 2 to 22 | (4, 21) |
| 18a | Echo | y = (x - □)^2 | y = (x - 5)^2 | none | 0 | 0 to 10 | 5 to 25 | (10, 25) |
| 8d | Crossroads | y = 2 - x + □ | y = 2 - x + 0 | 20 Finale | none | -10 to 10 | -10 to 10 | (-8, 10) |
| 19a | Loft | r = □ | r = 2 | none | theta | -3 to 2 | -3 to 3 | (2, 0) |
| 19b | Loft | r = □ | r = theta | 21 Weave | none | -3 to 3 | -3 to 3 | (-3, 0) |
| 20a | Finale | y = □x ^ 2 + 0 | y = 5x ^ 2 + 0 | 22 Circle Garden | none | -3 to 2 | 0 to 20 | (2, 20) |
...
| 27a | Rose Garden | r = sin(2□) | r = sin(2theta) | 28 Cardioid | none | -5 to 0 | -5 to 0 | (0.5, 0.5) |
| 27b | Rose Garden | r = 5□(2theta) | r = 5sin(2theta) | 29 Lemniscate | none | -4 to 4 | -4 to 4 | (3.5, 3.5) |
| 28a | Cardioid | r = 2 + □(theta) | r = 2 + sin(theta) | 30 Witch Window | none | -3 to 3 | -3 to 3 | (0, 3) |
| 29a | Lemniscate | (x ^ 2 + y ^ 2) ^ 2 = □ □(x ^ 2 - y ^ 2) | (x ^ 2 + y ^ 2) ^ 2 = 25(x ^ 2 - y ^ 2) | 31 Serpentine | none | -5 to 5 | -5 to 5 | (5, 0) |
| 30a | Witch Window | y = □ / (x ^ 2 + □) | y = 5 / (x ^ 2 + 2) | 32 Spiral Loft | none | -5 to 5 | -2 to 3 | (0, 2.5) |
| 31a | Serpentine | y = x / (x ^ 2 + 2) + □ | y = x / (x ^ 2 + 2) + 0 | 33 Fermat Spiral | none | -5 to 5 | -3 to 3 | (5, 0) |
...
| 34a | Final Rose | r = 2sin(□theta) | r = 2sin(5theta) | victory | none | -3 to 2 | -3 to 2 | (2, 0.5) |
