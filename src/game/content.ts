...
export const SECTIONS: SectionDefinition[] = [
  ...
  },
  {
    id: 'basin',
    title: 'Basin',
    blurb: 'Now the blank shifts the line below zero instead of flipping its direction, which makes the new 5 tile feel immediately useful.',
    accent: '#7ba5bf',
    world: { x: 1940, y: 600 },
    axes: {
      x: { min: 0, max: 10, tickStep: 1 },
  ...
  },
  {
    id: 'gallery',
    title: 'Gallery',
    blurb: 'This is the first left-side rewrite: the drawn line is still simple, but the notation now says the same idea in a more algebraic voice.',
    accent: '#cc8eb4',
    world: { x: 2340, y: 330 },
    axes: {
      x: { min: 0, max: 10, tickStep: 1 },
  ...
  },
  {
    id: 'glade',
    title: 'Glade',
    blurb: 'Natural log is the quiet inverse of Ember: it rises slowly, hugs the axis, and only lives to the right.',
    accent: '#c4947a',
    world: { x: -620, y: -1070 },
    axes: {
  ...
  },
  {
    id: 'chorus',
    title: 'Chorus',
    blurb: 'Cosine enters as a sibling to sine: same wave language, different starting phase.',
    accent: '#6b9fd1',
    world: { x: 520, y: 1160 },
    axes: {
  ...
  },
  {
    id: 'echo',
    title: 'Echo',
    blurb: 'A second cosine board shifts the whole wave over, making phase feel like a real puzzle tool instead of a graphing curiosity.',
    accent: '#82b8e2',
    world: { x: 120, y: 1360 },
    axes: {
      x: { min: 0, max: 3.2, tickStep: 0.5 },
  ...
  },
  {
    id: 'forge',
    title: 'Forge',
    blurb: 'Factored form feels different from a plain parabola because the two blanks control where the curve crosses the axis.',
    accent: '#9ac3e7',
    world: { x: -220, y: 1660 },
    axes: {
    ...
    slots: [
      { id: 'left', allowedTiles: ['5'], label: 'right root' },
  ...
  },
  {
    ...
    axes: {
      x: { min: -0.4, max: 2.2, tickStep: 0.5 },
      y: { min: -1.6, max: 1.6, tickStep: 0.5 },
    },
    visual: {
      terrainWidth: 620,
      terrainHeight: 290,
    ...
    slots: [{ id: 'lift', allowedTiles: ['1'], label: 'polar lift' }],
    goals: [
      {
        id: 'path-halo-finish',
